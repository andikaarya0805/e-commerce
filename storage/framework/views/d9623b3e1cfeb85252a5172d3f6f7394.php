...
<div id="cart-dropdown" class="absolute right-5 top-16 w-80 bg-white shadow-lg rounded-lg p-4 hidden">
    ...
    <div id="cart-footer" class="mt-3 border-t pt-2 hidden">
        ...
        <a href="<?php echo e(route('cart.index')); ?>" class="block bg-green-600 text-white text-center py-2 rounded">
            Checkout
        </a>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateCartCount() {
        fetch('<?php echo e(route("cart.count")); ?>', { headers: { 'Accept': 'application/json' } })
        .then(res => res.json())
        .then(data => {
    ...
    function loadCartItems() {
        fetch('<?php echo e(route("cart.items")); ?>', { headers: { 'Accept': 'application/json' } })
        .then(res => res.json())
        .then(data => {
    ...
    function deleteItem(id) {
        const url = '<?php echo e(url("/cart/remove")); ?>/' + id;
        fetch(url, {
            method: 'DELETE',
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\dika\tugas\ecommerce_vs\SonVape\resources\views/products/index.blade.php ENDPATH**/ ?>