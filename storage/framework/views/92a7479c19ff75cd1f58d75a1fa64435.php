...
<body class="bg-gray-100 flex flex-col min-h-screen">
    ...
    <header class="bg-white shadow sticky top-0 z-50">
        <div class="container mx-auto flex justify-between items-center py-3 px-4">
            <!-- Logo -->
            <a href="<?php echo e(url('/')); ?>" class="text-2xl font-bold text-blue-900">SonVape</a>

            <!-- Search -->
            <form action="<?php echo e(route('search')); ?>" method="GET" class="hidden md:flex flex-1 mx-6">
            ...
            <div class="flex items-center space-x-4">
                <?php if(auth()->guard()->guest()): ?>
                    <a href="<?php echo e(route('login')); ?>" class="text-blue-900 font-medium hover:text-blue-600">Login</a>
                    <a href="<?php echo e(route('register')); ?>" class="bg-blue-900 text-white px-4 py-2 rounded hover:bg-blue-700">Daftar</a>
                <?php endif; ?>
    ...
    <footer class="bg-blue-900 text-white mt-10">
        <div class="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 py-10 px-6">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="<?php echo e(url('/')); ?>" class="hover:underline">Beranda</a></li>
                    <li><a href="#" class="hover:underline">Produk</a></li>
                    <li><a href="<?php echo e(route('checkout')); ?>" class="hover:underline">Checkout</a></li>
                    <li><a href="<?php echo e(route('contact')); ?>" class="hover:underline">Kontak Kami</a></li>
                </ul>
            </div>
        ...
        <div class="bg-blue-950 text-center py-3 text-sm text-gray-300">
            &copy; <?php echo e(date('Y')); ?> SonVape Store. All rights reserved.
        </div>
    </footer>
    <!-- =============== END FOOTER ================= -->
...
<?php /**PATH D:\dika\tugas\ecommerce_vs\SonVape\resources\views/layouts/app.blade.php ENDPATH**/ ?>